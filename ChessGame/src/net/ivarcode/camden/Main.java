...
import net.ivarcode.camden.piece.Bishop;
import net.ivarcode.camden.piece.King;
import net.ivarcode.camden.piece.Knight;
import net.ivarcode.camden.piece.Pawn;
import net.ivarcode.camden.piece.Piece;
import net.ivarcode.camden.piece.Queen;
import net.ivarcode.camden.piece.Rook;
...
public class Main extends JApplet {
	...
	public void init() {
		...
		addMouseListener(new MouseAdapter() {
			...
			{
				game.makeMove(new Move(src,dest));
