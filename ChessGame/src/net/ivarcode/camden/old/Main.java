package net.ivarcode.camden.old;
...
public class Main extends JApplet {
	...
	boolean inGame = false, vs_bot = false, vs_human = false; //
	...
	private void bash(String in) {
		...
		case "p": {
			...
			if (color.equals("w") || color.equals("white")) {
				System.out.println("Starting new game as white.");
				color = "white";
			} else if (color.equals("b") || color.equals("black")) {
				System.out.println("Starting new game as black.");
				color = "black";
			} else {
